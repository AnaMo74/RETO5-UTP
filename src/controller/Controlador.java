...
public class Controlador implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == view.btnInforme1){
            String[] titulo =new String[] {"ID","Nombre","Apellido","Ciudad"};
        ...
        if (e.getSource() == view.btnInforme2){
            String[] titulo =new String[] {"IDProyecto","Constructora","Habitaciones","Ciudad"};
            view.mostrar.setColumnIdentifiers(titulo);
            view.mostrar.setNumRows(0);
        ...
        if (e.getSource() == view.btnInforme3){
            String[] titulo =new String[] {"IDCompra","Constructora","Banco"};
            view.mostrar.setColumnIdentifiers(titulo);
            view.mostrar.setNumRows(0);
